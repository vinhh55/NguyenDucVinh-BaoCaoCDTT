...
@section('content')
    <form action="{{ route('brand.update', ['brand' => $list_brand->id]) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                            ...
                            <div class="col-9">
                                <div class="mb-3">
                                    ...
                                    <input name="name" type="text" class="form-control" id="exampleFormControlInput1"
                                        placeholder="Nhập vào tên thương hiệu" value="{{ old('name', $list_brand->name) }}">
                                    @if ($errors->any())
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metakey" class="form-control" id="exampleFormControlTextarea1" placeholder="Nhập vào từ khóa"
                                        value="{{ old('metakey', $list_brand->metakey) }}" rows="3"></textarea>
                                    @if ($errors->any())
                                        <div class="text-danger">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metadesc" class="form-control" id="exampleFormControlTextarea2" placeholder="Nhập vào mô tả"
                                        value="{{ old('metadesc', $list_brand->metadesc) }}" rows="3"></textarea>
                                    @if ($errors->any())
                                        <div class="text-danger">
